...
try:
    ...
    class HeaderWidget(QWidget): def set_title(self, t): pass; def add_action_widget(self,w): pass; def clear_actions(self): pass
    class LogViewWidget(QWidget): def append_message(self,t): pass; def toggle_log_area(self): pass
