# linuxherd/managers/postgres_manager.py
# NEW FILE: Manages the bundled PostgreSQL server instance.
# Current time is Sunday, April 27, 2025 at 2:25:15 PM +04.
...
def _get_default_postgres_config_content(port_to_use):
    ...
    content = f"""# PostgreSQL configuration managed by LinuxHerd
...
def _get_default_pg_hba_content():
    ...
    content = f"""# pg_hba.conf managed by LinuxHerd
