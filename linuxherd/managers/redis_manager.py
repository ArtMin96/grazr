# linuxherd/managers/redis_manager.py
# Manages the bundled Redis server instance using core config and process manager.
# Current time is Saturday, April 26, 2025 at 3:00:01 AM +04.
...
def _get_default_redis_config_content():
    ...
    content = f"""# Redis configuration managed by LinuxHerd
daemonize no
pidfile {pidfile}
port {port}
bind 127.0.0.1 -::1
