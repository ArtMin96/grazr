# linuxherd/ui/php_version_item_widget.py
# Widget to display status and controls for a single PHP version row.
# Used within the QListWidget on PhpPage.
# Current time is Thursday, May 1, 2025 at 5:10:00 PM +04.
