# linuxherd/ui/site_list_item_widget.py
# Custom widget for displaying a single site in the SitesPage list.
# Includes site/lock icon, domain name, and favorite star button.
